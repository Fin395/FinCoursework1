...
from config import LOGS_FILE_REPORTS, REPORTS_DEFAULT_JSON
...
def spending_by_category(
    ...
    """Функция отбирает транзакции по тратам по определенной категории и записывает результат в файл"""
    try:
        if date:

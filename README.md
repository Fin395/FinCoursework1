...
В категории **"Сервисы"** реализована возможность осуществить поиск необходимых сведений по определенным
критериям, а также провести анализ работы некоторых пользовательских сервисов.
...
В  проекте реализованы функцииПримеры использования функций:
